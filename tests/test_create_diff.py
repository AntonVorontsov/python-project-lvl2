...
def test_create_diff():
    ...
    assert str(create_diff('gendiff/parsers/file1.yaml', 'gendiff/parsers/file2.yaml')) == result
    assert str(create_diff('gendiff/parsers/file1.json', 'gendiff/parsers/file2.yaml')) == result
